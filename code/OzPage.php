...
class OzPage extends Page {
	...
	$fields->addFieldToTab("Root.Content.Bottom", new HTMLEditorField('SideContent','Bottom Content'));
    return $fields;
...
class OzPage_Controller extends Page_Controller {
